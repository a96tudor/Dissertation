...
\begin{document}
	\begin{tikzpicture}
		...
		\draw[dotted, thick] (1,9) -- (3,6.5);  
		\draw[dotted, thick] (1,6) -- (3,3.5);  
		
		\draw[dotted, thick] (6,8) -- (4,6.5);  
		\draw[dotted, thick] (6,7) -- (4,3.5);  
		...
		\draw[fill=green!10] (0,6) rectangle (1,9);
		...
		\draw[fill=red!10] (6,7) rectangle (7,8); 	
	
		\foreach \m/\l [count=\y] in {miss,miss,miss,miss,miss,1}
		{
