...
\begin{document}
	\begin{tikzpicture}
		...
		\draw[dotted, thick] (1,6) -- (3,6.5);  
		\draw[dotted, thick] (1,3) -- (3,3.5);  
		
		\draw[dotted, thick] (6,5) -- (4,6.5);  
		\draw[dotted, thick] (6,4) -- (4,3.5);  
		...
		\draw[fill=green!10] (0,3) rectangle (1,6);
		...
		\draw[fill=red!10] (6,4) rectangle (7,5); 	
	
		\foreach \m/\l [count=\y] in {miss,miss,5,3,1,1}
		{
