...
\begin{document}
	\begin{tikzpicture}
		...
		\draw[dotted, thick] (1,5) -- (3,6.5);  
		\draw[dotted, thick] (1,2) -- (3,3.5);  
		
		\draw[dotted, thick] (6,4) -- (4,6.5);  
		\draw[dotted, thick] (6,3) -- (4,3.5);  
		...
		\draw[fill=green!10] (0,2) rectangle (1,5);
		...
		\draw[fill=red!10] (6,3) rectangle (7,4); 	
	
		\foreach \m/\l [count=\y] in {miss,5,5,3,1,1}
		{
